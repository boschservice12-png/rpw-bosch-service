...
| **F-147** | A Netlify-funkciok CORS-engedelylistaja MINDKET elo cimet ismeri. A csapatban ket oldal all ugyanerre a repora (beamish-arithmetic-e52bce es rpw-bosch-service); a lista eddig csak a regit ismerte, ezert az uj cimen az OCR, a classify es a levelkuldes NEMAN elhalt volna — a bongeszo blokkolja a valaszt, nem a szerver ad hibat | `functions/_shared.js` | — | `unit/test-p0-7-functions.js` | ✅ él |
