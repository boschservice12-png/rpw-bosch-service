/* BUILD: BLOCK-MODAL+SLIMBAR-L1K 2026-08-23 */
/* ============================================================
...
(function(root){
  ...
  function showBlockModal(opts){
    ...
    h+='<div><div class="rpw-bm-ht">'+bmEsc(um('bm_title',lang))+'</div>';
    h+='<div class="rpw-bm-hs">'+(tgtName?bmEsc(phaseName(target,lang)):'')+'</div></div></div>';
    ...
    h+='</div><div class="rpw-bm-ft"><button class="rpw-bm-b rpw-bm-b1" data-x>'+bmEsc(um('bm_ok',lang))+'</button>';
    h+='<button class="rpw-bm-b rpw-bm-b2" data-x>'+bmEsc(um('bm_go',lang))+'</button></div></div>';
    ov.innerHTML=h;
